...
map.getView().fit([-14701678.319383, 2543725.494178, -7028879.771908, 6586132.023749], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">US Cities Info Demo</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (71 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This is a web map desiigned to bring me up to speed - Moyosore Iyunade.';
            }
